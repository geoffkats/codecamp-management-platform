...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'requests'): ?>
                    <div class="min-w-48">
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'enrollments'): ?>
                    <div class="flex-1 min-w-64">
...
<?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <nav class="flex -mb-px overflow-x-auto">
                    ...
                    <button wire:click="$set('activeTab', 'requests')" 
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            Enrollment Requests
                            <!--[if BLOCK]><![endif]--><?php if($stats['pending_requests'] > 0): ?>
                    ...
                    <button wire:click="$set('activeTab', 'invitations')" 
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            Invitations
                            <!--[if BLOCK]><![endif]--><?php if($stats['pending_invitations'] > 0): ?>
            ...
            <div class="p-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'requests'): ?>
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php if($requests->count() > 0): ?>
                            <div class="grid gap-4">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'invitations'): ?>
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php if($invitations->count() > 0): ?>
                            <div class="grid gap-4">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $invitations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invitation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="mt-3 flex items-center gap-4 text-xs text-gray-500">
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php if($invitation->expires_at): ?>
                                                            <span>•</span>
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($invitation->status === 'pending' && !$invitation->isExpired()): ?>
                                                        <div class="mt-3">
                                                            <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($activeTab === 'enrollments'): ?>
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php if($enrollments->count() > 0): ?>
                            <div class="grid gap-4">
                                        ...
                                        <div class="p-6">
                                            <div class="flex items-start gap-4">
                                                <div class="relative">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($enrollment->completed_at): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showInviteModal): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selectedCourseId): ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <div class="border-3 border-dashed border-purple-300 dark:border-purple-700 rounded-2xl p-2 max-h-80 overflow-y-auto bg-gradient-to-br from-gray-50 to-purple-50/30 dark:from-gray-900/50 dark:to-purple-900/20">
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $availableStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <label class="flex items-center gap-4 p-4 mb-2 hover:bg-white dark:hover:bg-gray-800 rounded-xl cursor-pointer transition-all group border-2 border-transparent hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-lg">
                                            ...
                                            <div class="flex items-center gap-4 flex-1">
                                                <div class="relative">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($student->is_active): ?>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($student->points): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="text-center py-12">
                                            ...
                                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">
                                                <!--[if BLOCK]><![endif]--><?php if($searchStudent): ?>
...
<?php /**PATH C:\Users\User\Downloads\public_html\resources\views/livewire/admin/enrollment-management.blade.php ENDPATH**/ ?>