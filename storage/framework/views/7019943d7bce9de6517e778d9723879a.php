            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-400 to-yellow-600 text-white shadow-2xl transform transition-all hover:scale-105">
                ...
                <div class="relative flex items-center justify-between p-6">
                    <div>
                        ...
                        <p class="text-4xl font-black"><?php echo e($stats['total']); ?></p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-green-600 text-white shadow-2xl transform transition-all hover:scale-105">
                ...
                <div class="relative flex items-center justify-between p-6">
                    <div>
                        ...
                        <p class="text-4xl font-black"><?php echo e($stats['earned']); ?></p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-2xl transform transition-all hover:scale-105">
                ...
                <div class="relative flex items-center justify-between p-6">
                    <div>
                        ...
                        <p class="text-4xl font-black"><?php echo e($stats['available']); ?></p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-2xl transform transition-all hover:scale-105">
                ...
                <div class="relative flex items-center justify-between p-6">
                    <div>
                        ...
                        <p class="text-4xl font-black"><?php echo e($stats['completion']); ?>%</p>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::card','data' => ['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-gray-200/50 dark:border-zinc-700/50 shadow-2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-gray-200/50 dark:border-zinc-700/50 shadow-2xl']); ?>
            <div class="p-8">
                ...
                <div class="h-6 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden shadow-inner">
                    <div class="h-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-full transition-all duration-1000 shadow-lg relative overflow-hidden" 
                         style="width: <?php echo e($stats['completion']); ?>%">
...
<?php endif; ?>
        ...
        <!-- Recent Badges -->
        <!--[if BLOCK]><![endif]--><?php if($recentBadges->count() > 0): ?>
            <?php if (isset($component)) { $__componentOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::card','data' => ['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-yellow-200/50 dark:border-yellow-800/50 shadow-2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-yellow-200/50 dark:border-yellow-800/50 shadow-2xl']); ?>
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-2 gap-6 md:grid-cols-5">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge-icon','data' => ['icon' => $badge->icon ?? 'trophy','class' => 'w-16 h-16']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($badge->icon ?? 'trophy'),'class' => 'w-16 h-16']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white line-clamp-2"><?php echo e($badge->name); ?></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 font-medium">
                                    <!--[if BLOCK]><![endif]--><?php if($badge->pivot->earned_at): ?>
                                        <?php echo e(is_string($badge->pivot->earned_at) ? \Carbon\Carbon::parse($badge->pivot->earned_at)->diffForHumans() : $badge->pivot->earned_at->diffForHumans()); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::card','data' => ['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-gray-200/50 dark:border-zinc-700/50 shadow-xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm border-2 border-gray-200/50 dark:border-zinc-700/50 shadow-xl']); ?>
            <div class="p-6">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal26c546557cdc09040c8dd00b2090afd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model.live.debounce.300ms' => 'search','label' => 'Search Badges','placeholder' => 'Search by name or description...','icon' => 'magnifying-glass']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'search','label' => 'Search Badges','placeholder' => 'Search by name or description...','icon' => 'magnifying-glass']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button 
                                ...
                                class="px-4 py-3 rounded-xl font-bold text-sm transition-all duration-300 transform hover:scale-105 <?php echo e($filterStatus === 'all' ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg ring-4 ring-blue-200 dark:ring-blue-800' : 'bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-700'); ?>">
                                All
                            </button>
                            <button 
                                wire:click="filterByStatus('earned')"
                                class="px-4 py-3 rounded-xl font-bold text-sm transition-all duration-300 transform hover:scale-105 <?php echo e($filterStatus === 'earned' ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg ring-4 ring-blue-200 dark:ring-blue-800' : 'bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-700'); ?>">
                                Earned (<?php echo e($stats['earned']); ?>)
                            </button>
                            <button 
                                wire:click="filterByStatus('available')"
                                class="px-4 py-3 rounded-xl font-bold text-sm transition-all duration-300 transform hover:scale-105 <?php echo e($filterStatus === 'available' ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg ring-4 ring-blue-200 dark:ring-blue-800' : 'bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-700'); ?>">
                                Available (<?php echo e($stats['available']); ?>)
                            </button>
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
        ...
        <!-- Badges Grid -->
        <!--[if BLOCK]><![endif]--><?php if($badges->count() > 0): ?>
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="group relative transform transition-all duration-300 hover:scale-105">
                        <!--[if BLOCK]><![endif]--><?php if($isEarned): ?>
                                    ...
                                    <div class="relative mx-auto mb-4">
                                        ...
                                        <div class="relative flex h-28 w-28 items-center justify-center rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 shadow-2xl ring-4 ring-yellow-300 dark:ring-yellow-600 mx-auto transform group-hover:rotate-12 transition-transform duration-300">
                                            <div class="text-white filter drop-shadow-2xl">
                                                <?php if (isset($component)) { $__componentOriginal375a712a2300a078a8bd0da992c31f1b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal375a712a2300a078a8bd0da992c31f1b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge-icon','data' => ['icon' => $badge->icon ?? 'trophy','class' => 'w-20 h-20']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('badge-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($badge->icon ?? 'trophy'),'class' => 'w-20 h-20']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal375a712a2300a078a8bd0da992c31f1b)): ?>
<?php $attributes = $__attributesOriginal375a712a2300a078a8bd0da992c31f1b; ?>
...
<?php endif; ?>
                                    ...
                                    <!-- Badge Details -->
                                    <!--[if BLOCK]><![endif]--><?php if($badge->points_reward): ?>
                                        <div class="mb-4">
                                            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg">
                                                ...
                                                <span class="font-black"><?php echo e($badge->points_reward); ?> XP</span>
                                            </div>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                    <!-- Earned Status -->
                                    <!--[if BLOCK]><![endif]--><?php if($userBadge): ?>
                                        <div class="mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border-2 border-green-300 dark:border-green-700">
                                            <p class="text-xs font-bold text-green-700 dark:text-green-300 uppercase tracking-wide flex items-center justify-center gap-2">
                                                ...
                                                Earned <!--[if BLOCK]><![endif]--><?php if($userBadge->pivot->earned_at): ?>
                                                    <?php echo e(is_string($userBadge->pivot->earned_at) ? \Carbon\Carbon::parse($userBadge->pivot->earned_at)->diffForHumans() : $userBadge->pivot->earned_at->diffForHumans()); ?>
...
<?php endif; ?>
        ...
        <?php else: ?>
            <?php if (isset($component)) { $__componentOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4bce27d2c09d2f98a63d67977c1c3ec = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::card','data' => ['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm']); ?>
...
<?php /**PATH C:\Users\User\Downloads\public_html\resources\views/livewire/badges/index.blade.php ENDPATH**/ ?>