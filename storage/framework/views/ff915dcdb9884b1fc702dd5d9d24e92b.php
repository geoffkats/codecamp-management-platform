...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginalde111ceea3fafb2fde3418742a5c62ff = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalde111ceea3fafb2fde3418742a5c62ff = $attributes; } ?>
<?php $component = App\View\Components\Navigation\Sidebar::resolve(['user' => auth()->user()] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('navigation.sidebar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\Navigation\Sidebar::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalde111ceea3fafb2fde3418742a5c62ff)): ?>
<?php $attributes = $__attributesOriginalde111ceea3fafb2fde3418742a5c62ff; ?>
<?php unset($__attributesOriginalde111ceea3fafb2fde3418742a5c62ff); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalde111ceea3fafb2fde3418742a5c62ff)): ?>
<?php $component = $__componentOriginalde111ceea3fafb2fde3418742a5c62ff; ?>
<?php unset($__componentOriginalde111ceea3fafb2fde3418742a5c62ff); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.index','data' => ['variant' => 'outline','class' => 'rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','class' => 'rounded-lg']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.item','data' => ['icon' => 'shield-check','href' => ''.e(route('admin.audit.logs')).'','wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'shield-check','href' => ''.e(route('admin.audit.logs')).'','wire:navigate' => true]); ?>
...
<?php $component->withAttributes(['class' => 'w-full','position' => 'top','align' => 'start']); ?>
                        <button type="button" class="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-white/50 dark:hover:bg-gray-800/50 transition-colors" data-test="sidebar-menu-button">
                            ...
                            <div class="flex-1 min-w-0 text-left">
                                ...
                                <div class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e(Str::limit(auth()->user()->email ?: auth()->user()->student_id, 20)); ?></div>
                            </div>
                        ...
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                                ...
                                <div class="grid flex-1 text-start text-sm leading-tight">
                                    ...
                                    <span class="truncate text-xs"><?php echo e(auth()->user()->email ?: auth()->user()->student_id); ?></span>
                                </div>
                            </div>
                        </div>
                     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH C:\wamp64\www\codecamp-system\resources\views/components/layouts/app/sidebar.blade.php ENDPATH**/ ?>