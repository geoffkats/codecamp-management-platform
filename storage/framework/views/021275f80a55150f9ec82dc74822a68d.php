<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e($date); ?></p>
    </div>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-2xl p-12 text-center print-section">
                ...
                <div class="bg-white rounded-xl p-6 mb-6 inline-block">
                    <div class="w-48 h-48 flex items-center justify-center">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo e($code); ?>" 
                             alt="QR Code" 
                             class="w-full h-full">
                    </div>
...
<?php /**PATH C:\Users\User\Downloads\public_html\resources\views/livewire/attendance/teacher-code-display.blade.php ENDPATH**/ ?>