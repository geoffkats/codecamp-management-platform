...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="scroll-smooth">
    <head>
        ...
        <title><?php echo e($appName); ?> - <?php echo e($appTagline); ?></title>
    ...
    <body class="bg-white dark:bg-blue-950 antialiased">
                ...
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 group">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logo || $logoDark): ?>
                                <img src="<?php echo e(asset('storage/' . ($logo ?: $logoDark))); ?>" alt="<?php echo e($appName); ?>" class="h-10 dark:hidden">
                                <img src="<?php echo e(asset('storage/' . ($logoDark ?: $logo))); ?>" alt="<?php echo e($appName); ?>" class="h-10 hidden dark:block">
                            <?php else: ?>
                                <div class="w-10 h-10 rounded-lg bg-blue-900 dark:bg-blue-700 flex items-center justify-center">
                                    <span class="text-white font-bold text-xl"><?php echo e(substr($appName, 0, 1)); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="flex flex-col">
                                <span class="text-lg font-semibold text-gray-900 dark:text-white leading-tight"><?php echo e($appName); ?></span>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium text-sm">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium text-sm">
                                Sign In
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register')): ?>
                                <div class="hidden sm:flex items-center gap-3">
                                    ...
                                    <a href="<?php echo e(route('register')); ?>" class="px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold transition-all text-sm">
                                        Get Started
                                    </a>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold transition-all">
                                    Access Platform
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold transition-all">
                                    Start Free Trial
                                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                                    </svg>
                                </a>
                                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 bg-white dark:bg-blue-900 hover:bg-orange-50 dark:hover:bg-blue-800 text-blue-900 dark:text-white border-2 border-blue-900 dark:border-blue-700 rounded-lg font-semibold transition-all">
                                    Sign In
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <div class="relative hidden lg:block">
                        ...
                        <div class="relative bg-orange-50 dark:bg-blue-900 rounded-2xl overflow-hidden shadow-lg border border-orange-200 dark:border-blue-700">
                            ...
                            <img src="<?php echo e(asset('images/hero-training.svg')); ?>" alt="Professional training and certification" class="relative w-full h-full object-cover">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white dark:bg-blue-900 rounded-xl border border-orange-200 dark:border-blue-700 overflow-hidden">
                        <img src="<?php echo e(asset('images/resource-icdl.svg')); ?>" alt="ICDL adoption guide" class="w-full h-40 object-cover">
                        <div class="p-6">
                    ...
                    <div class="bg-white dark:bg-blue-900 rounded-xl border border-orange-200 dark:border-blue-700 overflow-hidden">
                        <img src="<?php echo e(asset('images/resource-roadmap.svg')); ?>" alt="Digital skills roadmap" class="w-full h-40 object-cover">
                        <div class="p-6">
                    ...
                    <div class="bg-white dark:bg-blue-900 rounded-xl border border-orange-200 dark:border-blue-700 overflow-hidden">
                        <img src="<?php echo e(asset('images/resource-analytics.svg')); ?>" alt="Learning analytics playbook" class="w-full h-40 object-cover">
                        <div class="p-6">
        ...
        <section id="contact" class="py-24 px-4 sm:px-6 lg:px-8 bg-blue-950 relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto text-center relative">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold transition-all">
                        Go to Dashboard
                    </a>
                <?php else: ?>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="<?php echo e(route('register')); ?>" class="inline-block px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold transition-all">
                            Request Demo
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="inline-block px-8 py-4 bg-transparent hover:bg-white/10 text-white border-2 border-white/30 rounded-lg font-semibold transition-all">
                            Sign In
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <footer class="bg-blue-900 text-blue-100 py-16 px-4 sm:px-6 lg:px-8 border-t border-blue-700 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto relative">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div>
                        <h3 class="text-white font-bold text-lg mb-4"><?php echo e($appName); ?></h3>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-gray-300">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                <li><a href="<?php echo e(route('courses.index')); ?>" class="hover:text-white transition-colors">Courses</a></li>
                                <li><a href="<?php echo e(route('dashboard')); ?>" class="hover:text-white transition-colors">Dashboard</a></li>
                            <?php else: ?>
                                <li><a href="<?php echo e(route('register')); ?>" class="hover:text-white transition-colors">Sign Up</a></li>
                                <li><a href="<?php echo e(route('login')); ?>" class="hover:text-white transition-colors">Sign In</a></li>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="pt-12 border-t border-blue-700 text-center text-sm">
                    <p class="mb-2">&copy; <?php echo e(date('Y')); ?> <?php echo e($appName); ?>. All rights reserved.</p>
...
<?php /**PATH C:\wamp64\www\codecamp-system\resources\views/welcome.blade.php ENDPATH**/ ?>