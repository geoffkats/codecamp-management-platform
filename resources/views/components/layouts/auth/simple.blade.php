                ...
                <div class="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div class="mb-10">
                        <a href="{{ route('home') }}" class="inline-flex items-center gap-3 group" wire:navigate>
                            @if($logo || $logoDark)
                                <img src="{{ asset('storage/' . ($logoDark ?: $logo)) }}" alt="{{ $appName }}" class="h-12 dark:hidden">
                                <img src="{{ asset('storage/' . ($logoDark ?: $logo)) }}" alt="{{ $appName }}" class="h-12 hidden dark:block">
                            @else
                            ...
                            @endif
                            <div>
                                <h2 class="text-lg font-bold text-gray-900 dark:text-white">{{ $appName }}</h2>
                    ...
                    <!-- Back to Home Link -->
                    <div class="mt-8">
                        <a href="{{ route('home') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors inline-flex items-center gap-2" wire:navigate>
