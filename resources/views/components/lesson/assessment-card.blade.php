...
<div class="flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
    ...
    <div class="p-5 flex-1 flex flex-col gap-3">
        ...
        <div>
            <div class="flex items-center gap-2 mb-2 flex-wrap">
                ...
                @if($assessment->is_locked)
                    <span class="inline-flex px-2 py-0.5 rounded text-[11px] font-bold text-amber-800 dark:text-amber-200 bg-amber-100 dark:bg-amber-900/30">
                        Locked
                    </span>
                @endif
                @if($pendingAttempt)
        ...
        <div class="flex gap-2 mt-auto pt-1">
            @if($assessment->is_locked && !auth()->user()?->hasAnyRole(['admin', 'supervisor', 'teacher', 'codecamp_trainer']))
                <span class="flex-1 inline-flex items-center justify-center px-3 py-2 text-xs font-semibold text-amber-800 dark:text-amber-200 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                    Locked until your instructor opens this lesson
                </span>
            @elseif($pendingAttempt)
