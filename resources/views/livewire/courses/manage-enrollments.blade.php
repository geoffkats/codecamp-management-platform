                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                                        <div class="flex items-start justify-between">
                                            <div class="flex items-start gap-4 flex-1">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-gray-900 dark:text-white">{{ $enrollment->user->name }}</h4>
                                                    ...
                                                    <div class="flex items-center gap-4 mt-2">
                                                        ...
                                                        <span class="text-xs font-medium text-purple-600 dark:text-purple-400">
                                                            Progress: {{ number_format($enrollment->progress_percentage, 1) }}%
                                                        </span>
                                                        @if($enrollment->completed_at)
                                                            <span class="px-2 py-0.5 rounded-full text-xs bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                                                Completed
                                                            </span>
                                                        @endif
                                                    </div>
