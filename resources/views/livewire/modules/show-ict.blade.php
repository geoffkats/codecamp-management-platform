<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="p-6 space-y-6">
        <div class="flex justify-end gap-3">
            <a href="{{ route('test-marks.index', ['module' => $module->id]) }}" wire:navigate class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">
                Enter Test Marks
            </a>
            <a href="{{ route('icdl-exam-marks.index', ['module' => $module->id]) }}" wire:navigate class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg">
                ICDL Exam Marks
            </a>
        </div>
